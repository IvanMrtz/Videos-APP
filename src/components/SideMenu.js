      ...
      <div id="Side-Menu">
        ...
        <div id="Side-Menu-Principal-Info">
          <div id="Img-Container">
            ...
            <label id="Button-Edit-User-Profile" htmlFor="Input-File"></label>
          </div>
        ...
        <div id="Container-Items">
          <div className="Side-Menu-Item">
            ...
            <Icon height="19" icon={tasksApp28Filled}></Icon>
          </div>
          <div className="Side-Menu-Item">
            <label>Friends</label>
            <Icon icon={userFriends}></Icon>
          </div>
          <div className="Side-Menu-Item">
          ...
          {currentUser ? (
            ...
            <div className="Side-Menu-Item item-bottom" id="side-menu-login">
